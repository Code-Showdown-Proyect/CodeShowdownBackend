...
from competition.interfaces.rest.competition_controller import router as competition_socket_router
...
app.include_router(competition_socket_router, prefix="/ws")
